...
- `GET /api/stats/`
  - يرجع: عدد الختمات المكتملة، رقم الختمة الحالية، عدد الأجزاء المحجوزة، الأجزاء المكتملة، إجمالي المشاركين.
- `GET /api/tasbeeh/`
  - يرجع عدادات التسبيح.
- `POST /api/tasbeeh/`
  - المدخلات: `{ "phrase": "سُبْحَانَ اللَّهِ", "name": "محمد" }`
  - يزيد العداد العالمي لعبارة التسبيح.
- `GET /api/activity/`
  - يرجع سجل النشاط المباشر.
- `GET/POST /api/dua-wall/`
  - عرض/إضافة أدعية المشاركين.
- `GET /api/profile-stats/?name=محمد`
  - إحصاءات وشارات المشارك.
